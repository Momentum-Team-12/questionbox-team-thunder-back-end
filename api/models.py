...
class Question(models.Model):
    ...
    favorite_by = models.ManyToManyField(User, related_name="favorite_questions", blank=True)
...
class Answer(models.Model):
    ...
    favorite_by = models.ManyToManyField(User, related_name="favorite_answers", blank=True)
